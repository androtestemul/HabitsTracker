...
import com.apska.habitstracker.presentation.model.HabitFilterFields
import com.apska.habitstracker.presentation.ui.screens.ViewModelEvent
import com.apska.habitstracker.presentation.ui.screens.addedithabit.FormError
import com.apska.habitstracker.presentation.ui.screens.addedithabit.ProcessResult
import com.apska.habitstracker.presentation.workers.ActualizeDatabaseWorker
import kotlinx.coroutines.launch
import java.util.ArrayList
import javax.inject.Inject

class HabitPagerViewModel @Inject constructor(
    ...
    private fun updateHabitsFromRemote() {
        viewModelScope.launch {
            ...
            if (updateHabitsFromRemoteUseCase.updateHabitsFromRemote()) {
                ...
                ActualizeDatabaseWorker.Companion.actualizeDatabase(context)
            }
        }
    }
