...
import com.apska.habitstracker.presentation.getScreenWidth
...
class ColorPicker(
    ...
    var selectedColor: Int = ColorView.Companion.DEFAULT_COLOR
        set(value) {
            field = value
    ...
    init {
        ...
        for (i in 0 until SQUARE_TOTAL_COUNT) {
            ...
            squareView.setOnClickListener {
                ...
                if (selectedColor != ColorView.Companion.DEFAULT_COLOR) {
